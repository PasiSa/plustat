...
from weekly import collect_weekly

settings = importlib.import_module(sys.argv[1])


if __name__ == '__main__':
    print(f"--- Starting plustat/periodic-weekly.py at {datetime.datetime.now()} ---")
    if len(sys.argv) < 2:
    ...
    print(f"--- Ending plustat/periodic-weekly.py at {datetime.datetime.now()} ---")
